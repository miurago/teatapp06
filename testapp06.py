...
def main():
    ...
    if choice == 'About':
        #image = Image.open()
        st.image("https://3.bp.blogspot.com/-Io5HgFHAY6g/VqqvxPSEc_I/AAAAAAAA3ZA/Wn401SOh3Wc/s450/bluebird_enjou.png")

        st.markdown("Built by Twitter Yakitori Bird")
        st.text("Version 0.1")

        st.markdown("For More Information check out   (https://wiz.ac.jp/)")
